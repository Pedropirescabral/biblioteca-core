...
public class LivroService {
    ...
    /**
     * Persiste alterações em um Livro já existente (ex.: quantidade
     * disponível alterada por um empréstimo/devolução). Mantém o acesso ao
     * repositório encapsulado dentro do Service (quem chama não precisa
     * conhecer LivroRepository).
     */
